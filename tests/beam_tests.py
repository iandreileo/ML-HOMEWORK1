...
def run_beam_tests():
    ...
    for problem_index in range(len(problems)):
        ...
        for b in list(reversed(B)):
            ...
            print("6" +  ","  +  "EASY"+  "," + str(problem_index) + "," + "LINEAR" + "," + str(beam_search1[0]) + "," + str(beam_search1[1]) + "," + str(beam_search1[2]) + "," + str(b))

            beam_search2 = beam_search(problems[problem_index], b, manhattan_heuristic, 1000000)
            print("6"+  ","  + "EASY"+  "," + str(problem_index) + "," + "MANHATTAN" + "," + str(beam_search2[0]) + "," + str(beam_search2[1]) + "," + str(beam_search2[2])  + "," +str(b))
